...
widgSelectBlockOptions.push("", "字体设置");
widgSelectBlockOptions.push("<h1>", "一号字");
widgSelectBlockOptions.push("<h2>", "二号字");
widgSelectBlockOptions.push("<h3>", "三号字");
widgSelectBlockOptions.push("<h4>", "四号字");
widgSelectBlockOptions.push("<h5>", "五号字");
widgSelectBlockOptions.push("<h6>", "六号字");
widgSelectBlockOptions.push("<p>", "标准字号");
...
function widgToolbar(theEditor)
{
	...
	for (var i = 0; i < widgToolbarItems.length; i++)
	{
		switch (widgToolbarItems[i])
		{
			...
			case "hyperlink":
				this.addButton(this.theList.id + "ButtonLink", "widgButtonLink", "增加链接", "link");
			...
			case "image":
				this.addButton(this.theList.id + "ButtonImage", "widgButtonImage", "链接图片", "image");
				
				break;
				
			case "htmlsource":
				this.addButton(this.theList.id + "ButtonHTML", "widgButtonHTML", "代码模式", "html");
